...
return(
  <Container as="main" className="flex flex-col gap-5 py-5 md:flex-row-reverse md:justify-between">
    <div className='relative overflow-hidden rounded-2xl'>
      ...
      <div className='absolute top-0 bottom-0 left-0 rigth-0 bg-gradient-to-t form-black to-transparent md:bg-gradient-to-r'></div>
    </div>

    <div className='md:w-[50%] flex flex-col gap-5'>
      <h1 className='text-2xl font-semibold '>Family Guys Quiz</h1>
